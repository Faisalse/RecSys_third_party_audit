...
<h2>Audit of third-party frameworks (RecBole, Elliot, and DaisyRec)</h2>

<p align="center">
  <img src="thirdparty.png" width="500", title="Credit goes to ChatGPT">
</p>


<h3>Introduction</h3>
<p align="justify">This reproducibility package was prepared for the paper titled "Do Third-Party Implementations Preserve Original Results?
Evidence from LightGCN and NGCF", which was accepted at XXX Conference. 
The results reported in this paper were achieved with the help of  <a href="https://recbole.io/dataset_list.html">RecBole</a>, <a href="https://elliot.readthedocs.io/en/latest/guide/config.html">Elliot</a>, and <a href="https://github.com/recsys-benchmark/daisyrec-v2.0">DaisyRec</a> frameworks. The picture is generated by ChatGPT.</p>
